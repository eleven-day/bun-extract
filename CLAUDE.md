...
**Core Value:** Zero-config input routing: give it anything (URL, file, video) and get useful text output — no environment setup, no path fixing, no dependency installing.
